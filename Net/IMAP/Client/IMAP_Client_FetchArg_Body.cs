...
namespace LumiSoft.Net.IMAP.Client
{
    ...
    /// </summary>
    public class IMAP_Client_FetchArg_Body : IMAP_Client_FetchArg
    {
        ...
        /// Default constructor.
        /// </summary>
        public IMAP_Client_FetchArg_Body()
        {
        }
        ...
        public IMAP_Client_FetchArg_Body(string section,int offset,int maxCount)
        {
            m_Section  = section;
            m_Offset   = offset;
            m_MaxCount = maxCount;
